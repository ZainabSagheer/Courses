    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="/courses" aria-label="Explore Courses" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            ...
            <div className="text-left">
              <div className="text-xl font-bold leading-none tracking-tight">Explore Courses</div>
            </div>
          </a>
          <a href="https://bitsolmarketing.com" target="_blank" rel="noopener noreferrer" aria-label="Visit BITSOL Marketing" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background">
            ...
            <div className="text-left">
              <div className="text-xl font-bold leading-none tracking-tight">BITSOL Marketing</div>
            </div>
          </a>
        </div>
      </div>
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-neutral-400 uppercase tracking-widest font-bold mb-1">Platform</span>
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Courses</span>
                        </div>
                        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center border border-white/10 shadow-lg shadow-black/50 overflow-hidden">
                          <img src="/icon.png" alt="BITSOL Logo" className="w-full h-full object-contain p-1" />
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        {/* Course Card 1 */}
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center bg-white/5 border border-white/10 shadow-lg relative overflow-hidden group hover:bg-white/10 transition-colors">
                          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center mr-3 flex-shrink-0 shadow-inner">
                            <svg className="w-6 h-6 text-white drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" />
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" />
                            </svg>
                          </div>
                          <div className="flex-1">
                            <h4 className="text-[11px] font-bold text-white mb-0.5 leading-tight line-clamp-1">Digital Marketing</h4>
                            <div className="flex items-center gap-1.5 mb-1.5">
                              <div className="flex -space-x-1">
                                <div className="w-3 h-3 rounded-full border border-black/50 bg-blue-300" />
                                <div className="w-3 h-3 rounded-full border border-black/50 bg-emerald-300" />
                                <div className="w-3 h-3 rounded-full border border-black/50 bg-purple-300" />
                              </div>
                              <span className="text-[8px] text-neutral-400">+1.2k joined</span>
                            </div>
                        ...
                        {/* Course Card 2 */}
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center bg-white/5 border border-white/10 shadow-lg relative overflow-hidden group hover:bg-white/10 transition-colors">
                          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center mr-3 flex-shrink-0 shadow-inner">
                            <svg className="w-6 h-6 text-white drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                            </svg>
                          </div>
                          <div className="flex-1">
                            <h4 className="text-[11px] font-bold text-white mb-0.5 leading-tight line-clamp-1">Stock Trading</h4>
                            <div className="flex items-center gap-1.5 mb-1.5">
                              <div className="flex -space-x-1">
                                <div className="w-3 h-3 rounded-full border border-black/50 bg-orange-300" />
                                <div className="w-3 h-3 rounded-full border border-black/50 bg-yellow-300" />
                              </div>
                              <span className="text-[8px] text-neutral-400">+850 joined</span>
                            </div>
                            <div className="w-full bg-white/10 rounded-full h-1">
                              <div className="bg-emerald-400 h-1 rounded-full w-1/2" />
                            </div>
                          </div>
                        </div>
                      </div>
