...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      const data = userDoc.exists() ? userDoc.data() : { role: 'student' };
      if (data.role === 'admin') {
        router.push('/admin');
      } else {
        router.push('/dashboard');
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#050816] relative overflow-hidden font-sans">
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[#00D9FF]/5 blur-[150px] -z-10" />
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#7C3AED]/5 blur-[150px] -z-10" />
        ...
        >
          ...
          >
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl font-medium tracking-tighter mb-3">
                Sign <span className="text-primary text-glow">In</span>
              </h1>
              <p className="text-foreground/40 text-sm font-light tracking-wide">Welcome back to BITSOL Marketing Institute.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="space-y-3">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full bg-white/5 border border-white/5 rounded-2xl pl-16 pr-6 py-5 focus:outline-none focus:border-[#00D9FF]/30 transition-all text-sm font-medium placeholder:text-white/10" 
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center px-2">
                  ...
                  <Link href="/forgot-password" size="sm" className="text-[10px] font-bold uppercase tracking-widest text-primary opacity-60 hover:opacity-100 transition-opacity">Forgotten?</Link>
                </div>
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full bg-white/5 border border-white/5 rounded-2xl pl-16 pr-16 py-5 focus:outline-none focus:border-[#00D9FF]/30 transition-all text-sm font-medium placeholder:text-white/10" 
              ...
              <div className="relative py-4">
                ...
                <div className="relative flex justify-center text-[10px] font-bold uppercase tracking-widest text-foreground/20">
                  <span className="px-4 bg-card/40">Or sign in with</span>
                </div>
              </div>
              ...
              >
                ...
                Sync via Google Google
              </button>
            </form>

            <div className="mt-12 text-center">
                <p className="text-[10px] font-bold uppercase tracking-widest text-foreground/20 mb-4">New here?</p>
                <Link href="/signup">
                    <button className="flex items-center gap-2 mx-auto text-primary text-xs font-bold uppercase tracking-widest hover:gap-4 transition-all group">
                        Create New Account <Zap className="w-3 h-3 transition-transform group-hover:scale-125" />
                    </button>
                </Link>
            </div>
          </TiltCard>
          ...
          <div className="mt-12 flex items-center justify-center gap-8 opacity-20 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-700">
             <div className="flex items-center gap-2">
                ...
                <span className="text-[8px] font-black uppercase tracking-[0.3em]">Encrypted Storage</span>
             </div>
             <div className="w-1 h-1 rounded-full bg-foreground/20" />
             <div className="flex items-center gap-2">
                <Zap className="w-4 h-4" />
                <span className="text-[8px] font-black uppercase tracking-[0.3em]">Secure Login</span>
             </div>
          </div>
        </motion.div>
      </div>
